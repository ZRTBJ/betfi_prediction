...
use crate::msg::{
    Config, ConfigResponse, Direction, ExecuteMsg, FastOracleExecuteMsg, FastOracleInstantiateMsg,
    FastOracleQueryMsg, InstantiateMsg, QueryMsg, StatusResponse,
};
